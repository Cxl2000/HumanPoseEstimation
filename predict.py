...
def predict_single_person():
    ...
    resize_hw = (256, 192)
    img_path = "./person.png"
    weights_path = "./params/pose_hrnet_w32_256x192.pth"
    ...
    data_transform = transforms.Compose([
        ...
        transforms.ToTensor(),
        transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]) # 3个通道所以3个均值方差
    ])
    ...
    with torch.inference_mode():
        ...
        plt.imshow(plot_img)
        plt.show()
        plot_img.save("predict_result.jpg")
